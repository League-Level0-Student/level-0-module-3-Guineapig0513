...
public class HighLowGame {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Heelloo! Thank you for buying a ticket called the "
				+ "'More fair lottery ticket' Make a guess now please inbetween 1-50");
		// 4. Convert the users’ answer to an int
		for (int honk = 10; honk > 0; honk--) {
			String guessString = JOptionPane.showInputDialog("Make your guess!! You have " +honk+ " tries left!");
			...
			// 8. Tell them it's too high
				...
				JOptionPane.showMessageDialog(null, "Thats too high! Go lower :D!");
			}
			// 9. if the guess is low
			// 10. Tell them it's too low
			else {
				JOptionPane.showMessageDialog(null, "Oof! Thats too low! go higher please!");
			}
